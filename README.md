> **Это форк с локальными доработками.** Разметка целиком локальная (whisper вместо
> SpeechCore), добавлены главы, диаризация, нормализация терминов, очистка секретов,
> веб-плеер и упаковка результата для раздачи.
>
> **Весь путь одной командой:** `./run.sh all путь/к/видео.mp4`
>
> Подробности, все команды и найденные грабли — в [LOCAL.md](LOCAL.md).
