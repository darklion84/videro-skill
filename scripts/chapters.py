...
def build_prompt(scenes: list[dict], n_chapters: int, n_highlights: int, offset: int = 0,
    ...
    return (
        ...
        "- у сцены может не быть ни описания, ни текста с экрана: значит демонстрации не было, "
        "шло обсуждение голосом. Такие сцены НЕ склеивай в один кусок по признаку пустоты — "
        "режь их по смыслу речи ровно так же, как остальные;\n"
